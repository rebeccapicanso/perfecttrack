# iterates through each shot, identifying objects in that scene and indexing in a .json.
...
# truly any model will work here - it's recommended to keep the model small
# unless you're using colab or a machine with a lot of memory.
